...
See hoidla sisaldab **ProjectLibre** kasutamist käsitlevat dokumentatsiooniprojekti. Tegemist on kompaktse õppematerjaliga, mis on üles ehitatud kolme praktilise teema ümber:
...
### 1. Kalendri loomine ProjectLibre
...
![Uue kalendri tegemine](docs/images/avaleht1.png)

![Uue kalendri loomise dialoog](docs/images/avaleht2.png)

![Projekti info valitud kalendriga](docs/images/avaleht3.png)

### Diagrammi näide

![Kulude seisu diagramm arvutatud väärtuste ja edenemisandmetega](docs/images/diagramm2.png)
...
this is for branch ms project now create for projectlibre